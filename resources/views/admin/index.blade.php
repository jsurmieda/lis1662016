...
<!-- top tiles -->
          <div class="row tile_count">
            ...
            <div class="col-md-6 col-sm-4 col-xs-6 tile_stats_count">
              <span class="count_top"><i class="fa fa-clock-o"></i> Today is</span>
              <div class="count" id="txt"></div>
            </div>
          </div>
          <!-- /top tiles -->
          <hr>
          <div class="row">
            ...
            <div class="col-md-6 col-sm-4 col-xs-12">
              <div class="x_panel tile fixed_height_320">
                <div class="x_title">
                  <h2>No. of Case Reports per Region</h2>
                ...
                <div class="x_content">
                  ...
                  @foreach($regionalofficeLists as $regionalofficeList)
                  <div class="widget_summary">
                    <div class="w_left w_25">
                      <span>{!! $regionalofficeList->region_name !!}</span>
                    </div>
          ...
          <!--Notifications-->
            <div class="col-md-6 col-sm-4 col-xs-12">
              <div class="x_panel">
                <div class="x_title">
                  <h2>Notifications <small>Sessions</small></h2>
                  <ul class="nav navbar-right panel_toolbox">
                    <li><a class="collapse-link"><i class="fa fa-chevron-up"></i></a>
                    </li>
                    <li class="dropdown">
            ...
            <div class="col-md-8 col-sm-8 col-xs-12">
              ...
              <div class="row">
                ...
                <div class="col-md-12 col-sm-12 col-xs-12">
                  <div class="x_panel">
                    <div class="x_title">
                      <h2>Indigent Population per Region <small>geo-presentation</small></h2>
                      <ul class="nav navbar-right panel_toolbox">
                        <li><a class="collapse-link"><i class="fa fa-chevron-up"></i></a>
                        </li>
                        <li class="dropdown">
