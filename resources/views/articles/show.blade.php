...
@section('content')
    <section id="article" class="container">
        <div class="center">
            ...
            <h2><a href="{{ url('articles/')}}/{!! $articleDetails->id !!}/edit"><i class="fa fa-pencil"></i>&nbsp;Edit</a>
            <a href="{{ url('articles/') }}/{!! $articleDetails->id !!}"><i class="fa fa-trash"></i>&nbsp;Delete</a>
            {{ Form::open([
                'method'=>'delete',
                'action' => ['ArticleController@destroy', $articleDetails->id]
                ]) }} 
                {{ Form::submit('Delete') }}
            {{ Form::close() }}
            </h2>
                        ...
                        <img class="img-responsive img-blog" src="images/blog/blog1.jpg" width="100%" alt="" />
                            <div class="row">  
                                <div class="col-xs-12 col-sm-2 text-center">
                                    <div class="entry-meta">
                                        ...
                                        <span>
                                            ...
                                            <a href="#">by {!! $articleDetails->user_id !!}</a>
                                            <!-- should be username -->
                                        </span><br />

                                        <span id="publish_date">{!! date('M j Y g:i A', strtotime($articleDetails->created_at)) !!}</span>
                                ...
                                <div class="col-xs-12 col-sm-10 blog-content">
                                    ...
                                    <p class="lead">{!! $articleDetails->articlebody !!}</p>
                                    <!-- Keywords/Tags
                                    <div class="post-tags">
...
<!--
                ...
                <!--</aside>     -->
                <hr />
                <a href="{{ url('articles/')}}/{!! $articleDetails->id !!}/edit"><i class="fa fa-pencil"></i>&nbsp;Edit this article</a>
            <a href="{{ url('articles/') }}/{!! $articleDetails->id !!}"><i class="fa fa-trash"></i>&nbsp;Delete this article</a>
            {{ Form::open([
                'method'=>'delete',
                'action' => ['ArticleController@destroy', $articleDetails->id]
                ]) }} 
