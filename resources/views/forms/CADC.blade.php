...
@section('content')
<!-- Smart Wizard -->
                    <p>Petition for conversion of Certificate of Ancestral Domain Claim into Certificate of Ancestral Domain Title</p>
                    <div id="wizard" class="form_wizard wizard_horizontal">
                        ...
                        <li>
                          <a href="#step-1">
                            ...
                            <span class="step_descr">
                                              Step 1<br />
                                              <small>Information of CADC</small>
                                          </span>
                          </a>
                        </li>
                        <li>
                      ...
                      <div id="step-1">
                        <form class="form-horizontal form-label-left">
                          <div class="form-group">
                            <label class="control-label col-md-3 col-sm-3 col-xs-12" for="first-name">CADC Number <span class="required">*</span>
                            </label>
                          ...
                          <div class="form-group">
                            <label class="control-label col-md-3 col-sm-3 col-xs-12" for="last-name">Location of Ancestral Domain<span class="required">*</span>
                            </label>
                            <div class="col-md-6 col-sm-6 col-xs-12">
                         ...
                         <table>
                           ...
                           <p>Number of Right Holders:</p>
                            <label class="control-label col-md-3 col-sm-3 col-xs-12">Community/ies<span class="required">*</span>
                            </label>
                            <div class="col-md-6 col-sm-6 col-xs-12">
                              <input id="birthday" class="date-picker form-control col-md-7 col-xs-12" required="required" type="text">
                            </div>
                            ...
                            <div class="form-group">
                            <label class="control-label col-md-3 col-sm-3 col-xs-12">Individual Community members<span class="required">*</span>
                            </label>
                            <div class="col-md-6 col-sm-6 col-xs-12">
                              <input id="birthday" class="date-picker form-control col-md-7 col-xs-12" required="required" type="text">
                            </div>
                      ...
                      <div id="step-2">
                       ...
                       <form class="form-horizontal form-label-left">
                       <div class="form-group">
                       <p>Particular area for inclusion from the CADC area (if any)</p>
                            <table>
                							<tr>
                								<th>Barangay</th>
                								<th>Municipality</th>
                          ...
                          <div class="form-group">
                          <p>Particular area for exclusion from the CADC area (if any)</p>
                            <table>
                              <tr>
                                <th>Barangay</th>
                                <th>Municipality</th>
